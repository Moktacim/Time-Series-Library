...
#parser.add_argument('--subset_percentage', type=float, default=0.4, help='size of the subset for training')
...
parser.add_argument('--frequency_map', type=int, default=12, help='feature map of 12 only for kiglis')
